...
> Lancement : `.venv/bin/python -m studio` puis http://localhost:8420, ou en conteneur GPU : `docker compose up -d`
> (image `ghcr.io/ralphi2811/yue2-studio`, voir [le README du studio](studio/README.md#déploiement-en-conteneur)).
> Tests : `.venv/bin/python -m pytest studio/tests -q`. Aucune authentification intégrée : usage local ou réseau privé.
